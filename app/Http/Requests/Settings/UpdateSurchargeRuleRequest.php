...
class UpdateSurchargeRuleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'overtime_accrual_mode' => ['required', Rule::in(['daily', 'weekly'])],
            'night_settlement_mode' => ['required', Rule::in(['immediate', 'deferred'])],
            ...
            'pay_night_dominical' => ['required', 'boolean'],
            'pay_night_holiday' => ['required', 'boolean'],
            'pay_overtime_dominical' => ['required', 'boolean'],
            'pay_overtime_holiday' => ['required', 'boolean'],
            'pay_overtime_night' => ['required', 'boolean'],
    ...
    public function messages(): array
    {
        return [
            ...
            'overtime_accrual_mode.required' => 'Debes indicar cómo se acumulan las horas extra.',
            'overtime_accrual_mode.in' => 'El modo de acumulación de horas extra debe ser diario o semanal.',
            'night_settlement_mode.required' => 'Debes indicar cómo se liquida el recargo nocturno.',
            'night_settlement_mode.in' => 'El modo de liquidación nocturna debe ser inmediato o diferido.',
            ...
            'pay_night_dominical.required' => 'Debes indicar si se paga el recargo nocturno dominical.',
            'pay_night_dominical.boolean' => 'El valor de pago de nocturno dominical no es válido.',
            'pay_night_holiday.required' => 'Debes indicar si se paga el recargo nocturno festivo.',
            'pay_night_holiday.boolean' => 'El valor de pago de nocturno festivo no es válido.',
            'pay_overtime_dominical.required' => 'Debes indicar si se paga el recargo de horas extra dominical.',
            'pay_overtime_dominical.boolean' => 'El valor de pago de horas extra dominical no es válido.',
            'pay_overtime_holiday.required' => 'Debes indicar si se paga el recargo de horas extra festivas.',
            'pay_overtime_holiday.boolean' => 'El valor de pago de horas extra festivas no es válido.',
            'pay_overtime_night.required' => 'Debes indicar si se paga el recargo de horas extra nocturnas.',
            'pay_overtime_night.boolean' => 'El valor de pago de horas extra nocturnas no es válido.',
