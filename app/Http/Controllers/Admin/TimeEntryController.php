    ...
    public function edit(TimeEntry $timeEntry): Response
    {
        ...
        return Inertia::render('Admin/TimeEntries/Edit', [
            'entry' => [
                ...
                'dominical_hours' => $timeEntry->dominical_hours,
                'night_dominical_hours' => $timeEntry->night_dominical_hours,
                'holiday_hours' => $timeEntry->holiday_hours,
                'night_holiday_hours' => $timeEntry->night_holiday_hours,
                'overtime_day_hours' => $timeEntry->overtime_day_hours,
                'overtime_night_hours' => $timeEntry->overtime_night_hours,
                'overtime_day_dominical_hours' => $timeEntry->overtime_day_dominical_hours,
                'overtime_night_dominical_hours' => $timeEntry->overtime_night_dominical_hours,
                'overtime_day_holiday_hours' => $timeEntry->overtime_day_holiday_hours,
                'overtime_night_holiday_hours' => $timeEntry->overtime_night_holiday_hours,
