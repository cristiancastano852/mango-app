...
export type TimeEntry = {
    ...
    night_hours: string;
    dominical_hours: string;
    night_dominical_hours: string;
    holiday_hours: string;
    night_holiday_hours: string;
    overtime_day_hours: string;
    overtime_night_hours: string;
    overtime_day_dominical_hours: string;
    overtime_night_dominical_hours: string;
    overtime_day_holiday_hours: string;
    overtime_night_holiday_hours: string;
    status: string;
...
export type DailyWorkDay = {
    ...
    dominical_hours: number | null;
    night_dominical_hours: number | null;
    holiday_hours: number | null;
    night_holiday_hours: number | null;
    overtime_day_hours: number | null;
    overtime_night_hours: number | null;
    overtime_day_dominical_hours: number | null;
