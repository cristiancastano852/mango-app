...
## Purpose
Define la selección de periodo de pago (quincena/mes) y el rango libre en los reportes, y el prorrateo del salario base usando el mes comercial de 30 días (15 por quincena) para que el monto no dependa de los días calendario reales.
## Requirements
