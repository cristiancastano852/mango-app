# payroll-deductions Specification

## Purpose
Define el registro de descuentos por novedad (faltas, licencias y permisos no remunerados) contra empleados `monthly` y su efecto sobre el salario base prorrateado del periodo, restando cada día descontado a razón de `monthly_base_salary / 30` para que el descuento no dependa de los días calendario reales del mes.
## Requirements
